...
#define LAS_FAN_Pin GPIO_PIN_15
#define LAS_FAN_GPIO_Port GPIOB
#define GREEN_LED_PWM_Pin GPIO_PIN_6
#define GREEN_LED_PWM_GPIO_Port GPIOC
#define RED_LED_PWM_Pin GPIO_PIN_7
#define RED_LED_PWM_GPIO_Port GPIOC
#define BLUE_LED_PWM_Pin GPIO_PIN_8
#define BLUE_LED_PWM_GPIO_Port GPIOC
...
#define EDAC3_SDI_Pin GPIO_PIN_12
#define EDAC3_SDI_GPIO_Port GPIOC
#define EDAC3_SCK_Pin GPIO_PIN_2
#define EDAC3_SCK_GPIO_Port GPIOD
#define EDAC3_CS_Pin GPIO_PIN_3
#define EDAC3_CS_GPIO_Port GPIOB
