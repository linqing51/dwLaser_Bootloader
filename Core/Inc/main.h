...
#define LASER0_PD_Pin GPIO_PIN_2
#define LASER0_PD_GPIO_Port GPIOA
#define LASER1_PD_Pin GPIO_PIN_3
...
#define U5POW_OUT_Pin GPIO_PIN_14
#define U5POW_OUT_GPIO_Port GPIOB
#define LASER0_AIM_Pin GPIO_PIN_15
#define LASER0_AIM_GPIO_Port GPIOB
#define LASER1_AIM_Pin GPIO_PIN_8
#define LASER1_AIM_GPIO_Port GPIOC
...
#define LASER0_START_IN_Pin GPIO_PIN_15
#define LASER0_START_IN_GPIO_Port GPIOA
#define LASER1_START_IN_Pin GPIO_PIN_10
#define LASER1_START_IN_GPIO_Port GPIOC
#define ESTOP_NC_IN_Pin GPIO_PIN_11
#define ESTOP_NC_IN_GPIO_Port GPIOC
#define INTERLOCK_NC_IN_Pin GPIO_PIN_12
#define INTERLOCK_NC_IN_GPIO_Port GPIOC
#define FAN5V_OUT_Pin GPIO_PIN_2
#define FAN5V_OUT_GPIO_Port GPIOD
#define TEC_PWM_OUT_Pin GPIO_PIN_4
#define TEC_PWM_OUT_GPIO_Port GPIOB
#define ALARM_LED_OUT_Pin GPIO_PIN_5
#define ALARM_LED_OUT_GPIO_Port GPIOB
#define LASER0_LED_OUT_Pin GPIO_PIN_6
#define LASER0_LED_OUT_GPIO_Port GPIOB
#define LASER1_LED_OUT_Pin GPIO_PIN_7
