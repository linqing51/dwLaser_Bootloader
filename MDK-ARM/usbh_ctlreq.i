...
#line 126 "../Middlewares/ST/STM32_USB_Host_Library/Core/Inc/usbh_ctlreq.h"
...
#line 22 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
                                   ...
                                   uint8_t DeviceAddress)
{
  if (phost->RequestState == CMD_SEND)
  {
    phost->Control.setup.b.bmRequestType = 0x00U | 0x00U |                                            0x00U;
...
#line 569 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
      break;
...
#line 596 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
      break;
...
#line 673 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
      }
      else
      {
...
#line 688 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
        }
      }
      break;
...
#line 718 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
      }
...
#line 734 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
      }
      else
      {
...
#line 750 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
        }
      }
      break;
...
#line 780 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
      }
...
#line 797 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
      }
...
#line 811 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
      }
      else
      {
        if (URB_Status == USBH_URB_ERROR)
...
#line 828 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
        }
      }
      break;
...
#line 859 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
      }
      else if (URB_Status == USBH_URB_ERROR)
      {
        phost->Control.state = CTRL_ERROR;

#line 872 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
      }
      else
      {
        if (URB_Status == USBH_URB_STALL)
...
#line 888 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
        }
      }
      break;
...
#line 914 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
      }
      else if (URB_Status == USBH_URB_NOTREADY)
      {
        phost->Control.state = CTRL_STATUS_OUT;

#line 927 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
      }
      else
      {
        if (URB_Status == USBH_URB_ERROR)
...
#line 942 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_ctlreq.c"
        }
      }
      break;
    ...
    case CTRL_ERROR:
      ...
      else
      {
        ...
        do { printf("ERROR: ") ; printf("Control error: Device not responding"); printf("\n"); } while (0);
