...
#line 23 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"
...
#line 87 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"
                              ...
                              uint8_t id), uint8_t id)
{
  ...
  if (phost == 0)
  {
    do { printf("ERROR: ") ; printf("Invalid Host handle"); printf("\n"); } while (0);
    return USBH_FAIL;
  }
...
#line 164 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"
...
USBH_StatusTypeDef USBH_RegisterClass(USBH_HandleTypeDef *phost, USBH_ClassTypeDef *pclass)
{
  ...
  if (pclass != 0)
  {
    ...
    {
      do { printf("ERROR: ") ; printf("Max Class Number reached"); printf("\n"); } while (0);
      status = USBH_FAIL;
    }
  }
  else
  {
    do { printf("ERROR: ") ; printf("Invalid Class handle"); printf("\n"); } while (0);
    status = USBH_FAIL;
  }
...
USBH_StatusTypeDef USBH_SelectInterface(USBH_HandleTypeDef *phost, uint8_t interface)
{
  ...
  if (interface < phost->device.CfgDesc.bNumInterfaces)
  {
    ...
    do { printf("Switching to Interface (#%d)", interface); printf("\n"); } while (0);
    do { printf("Class    : %xh", phost->device . CfgDesc . Itf_Desc[interface]. bInterfaceClass); printf("\n"); } while (0);
    do { printf("SubClass : %xh", phost->device . CfgDesc . Itf_Desc[interface]. bInterfaceSubClass); printf("\n"); } while (0);
    do { printf("Protocol : %xh", phost->device . CfgDesc . Itf_Desc[interface]. bInterfaceProtocol); printf("\n"); } while (0);
  }
  else
  {
    do { printf("ERROR: ") ; printf("Cannot Select This Interface."); printf("\n"); } while (0);
    status = USBH_FAIL;
  }
...
#line 446 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"
...
USBH_StatusTypeDef  USBH_Process(USBH_HandleTypeDef *phost)
{
  ...
  switch (phost->gState)
  {
    case HOST_IDLE :
      ...
      {
        do { printf("USB Device Connected"); printf("\n"); } while (0);
...
#line 493 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"
      }
      break;
    ...
    case HOST_DEV_WAIT_FOR_ATTACHMENT:  
      ...
      {
        do { printf("USB Device Reset Completed"); printf("\n"); } while (0);
        phost->device.RstCnt = 0U;
      ...
      else
      {
        if (phost->Timeout > 1000U)
        {
          ...
          if (phost->device.RstCnt > 3U)
          {
            ...
            do { printf("USB Reset Failed, Please unplug the Device."); printf("\n"); } while (0);
...
#line 534 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"
      break;
...
#line 571 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"
      break;
    ...
    case HOST_ENUMERATION:
      ...
      if (status == USBH_OK)
      {
        ...
        do { printf("Enumeration done."); printf("\n"); } while (0);

        phost->device.current_interface = 0U;

        if (phost->device.DevDesc.bNumConfigurations == 1U)
        {
          do { printf("This device has only 1 configuration."); printf("\n"); } while (0);
...
#line 600 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"
      }
      break;
...
#line 619 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"
      }
    }
    break;
    ...
    case HOST_SET_CONFIGURATION:
      ...
      if (USBH_SetCfg(phost, (uint16_t)phost->device.CfgDesc.bConfigurationValue) == USBH_OK)
      {
        ...
        do { printf("Default configuration set."); printf("\n"); } while (0);
      }

#line 639 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"
      break;
    ...
    case  HOST_SET_WAKEUP_FEATURE:
      ...
      if ((phost->device.CfgDesc.bmAttributes) & (1U << 5))
      {
        ...
        {
          do { printf("Device remote wakeup enabled"); printf("\n"); } while (0);
...
#line 664 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"
      break;
    ...
    case HOST_CHECK_CLASS:
      ...
      {
        do { printf("No Class has been registered."); printf("\n"); } while (0);
      }
      else
      {
        phost->pActiveClass = 0;
        ...
        if (phost->pActiveClass != 0)
        {
          if (phost->pActiveClass->Init(phost) == USBH_OK)
          {
            ...
            do { printf("%s class started.", phost->pActiveClass->Name); printf("\n"); } while (0);
          ...
          {
            phost->gState = HOST_ABORT_STATE;
            do { printf("Device not supporting %s class.", phost->pActiveClass->Name); printf("\n"); } while (0);
          }
        }
        else
        {
          phost->gState = HOST_ABORT_STATE;
          do { printf("No registered class for this device."); printf("\n"); } while (0);
        }
      }

#line 716 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"
      break;
    ...
    case HOST_CLASS_REQUEST:
      ...
      if (phost->pActiveClass != 0)
      {
        ...
        {
          phost->gState = HOST_ABORT_STATE;
          do { printf("ERROR: ") ; printf("Device not responding Please Unplug."); printf("\n"); } while (0);
        }
        else
        {
      ...
      {
        phost->gState = HOST_ABORT_STATE;
        do { printf("ERROR: ") ; printf("Invalid Class Driver."); printf("\n"); } while (0);
      }
#line 751 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"
      break;
    ...
    case HOST_DEV_DISCONNECTED :
      ...
      do { printf("USB Device disconnected"); printf("\n"); } while (0);
...
#line 800 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"
      break;
...
static USBH_StatusTypeDef USBH_HandleEnum(USBH_HandleTypeDef *phost)
{
  ...
  switch (phost->EnumState)
  {
    case ENUM_IDLE:
      ...
      {
        do { printf("ERROR: ") ; printf("Control error: Get Device Descriptor request failed"); printf("\n"); } while (0);
        phost->device.EnumCnt++;
        if (phost->device.EnumCnt > 3U)
        {
           
          do { printf("Control error, Device not Responding Please unplug the Device."); printf("\n"); } while (0);
          phost->gState = HOST_ABORT_STATE;
        }
        else
        {
    ...
    case ENUM_GET_FULL_DEV_DESC:
      ...
      if (ReqStatus == USBH_OK)
      {
        do { printf("PID: %xh", phost->device . DevDesc . idProduct); printf("\n"); } while (0);
        do { printf("VID: %xh", phost->device . DevDesc . idVendor); printf("\n"); } while (0);

        phost->EnumState = ENUM_SET_ADDR;
      }
      else if (ReqStatus == USBH_NOT_SUPPORTED)
      {
        do { printf("ERROR: ") ; printf("Control error: Get Full Device Descriptor request failed"); printf("\n"); } while (0);
        phost->device.EnumCnt++;
        if (phost->device.EnumCnt > 3U)
        {
    ...
    case ENUM_SET_ADDR:
      ...
      if (ReqStatus == USBH_OK)
      {
        ...
        do { printf("Address (#%d) assigned.", phost->device . address); printf("\n"); } while (0);
      ...
      {
        do { printf("ERROR: ") ; printf("Control error: Device Set Address request failed"); printf("\n"); } while (0);
    ...
    case ENUM_GET_CFG_DESC:
      ...
      {
        do { printf("ERROR: ") ; printf("Control error: Get Device configuration descriptor request failed"); printf("\n"); } while (0);
        phost->device.EnumCnt++;
        if (phost->device.EnumCnt > 3U)
        {
    ...
    case ENUM_GET_MFC_STRING_DESC:
      if (phost->device.DevDesc.iManufacturer != 0U)
      {
        ...
        if (ReqStatus == USBH_OK)
        {
          ...
          do { printf("Manufacturer : %s", (char *)(void *)phost->device . Data); printf("\n"); } while (0);
          phost->EnumState = ENUM_GET_PRODUCT_STRING_DESC;

#line 1030 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"
        }
        else if (ReqStatus == USBH_NOT_SUPPORTED)
        {
          do { printf("Manufacturer : N/A"); printf("\n"); } while (0);
          phost->EnumState = ENUM_GET_PRODUCT_STRING_DESC;

#line 1044 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"
        }
        else
        {
...
#line 1063 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"
      }
      break;
    ...
    case ENUM_GET_PRODUCT_STRING_DESC:
      if (phost->device.DevDesc.iProduct != 0U)
      {
        ...
        if (ReqStatus == USBH_OK)
        {
          ...
          do { printf("Product : %s", (char *)(void *)phost->device . Data); printf("\n"); } while (0);
          phost->EnumState = ENUM_GET_SERIALNUM_STRING_DESC;
        }
        else if (ReqStatus == USBH_NOT_SUPPORTED)
        {
          do { printf("Product : N/A"); printf("\n"); } while (0);
          phost->EnumState = ENUM_GET_SERIALNUM_STRING_DESC;

#line 1091 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"
        }
        else
        {
...
#line 1110 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"
      }
      break;
    ...
    case ENUM_GET_SERIALNUM_STRING_DESC:
      if (phost->device.DevDesc.iSerialNumber != 0U)
      {
        ...
        if (ReqStatus == USBH_OK)
        {
          ...
          do { printf("Serial Number : %s", (char *)(void *)phost->device . Data); printf("\n"); } while (0);
          Status = USBH_OK;
        }
        else if (ReqStatus == USBH_NOT_SUPPORTED)
        {
          do { printf("Serial Number : N/A"); printf("\n"); } while (0);
          Status = USBH_OK;
        }
        else
        {
...
#line 1207 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"
...
#line 1259 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"
...
USBH_StatusTypeDef  USBH_LL_Disconnect(USBH_HandleTypeDef *phost)
{
  ...
  USBH_FreePipe(phost, phost->Control.pipe_in);
  USBH_FreePipe(phost, phost->Control.pipe_out);
#line 1291 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"

  return USBH_OK;
}


#line 1354 "../Middlewares/ST/STM32_USB_Host_Library/Core/Src/usbh_core.c"
