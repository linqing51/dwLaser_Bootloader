...
#line 242 "../Drivers/CMSIS/Device/ST/STM32F4xx/Include/stm32f4xx.h"
...
#line 50 "../Core/Src/system_stm32f4xx.c"
...
#line 83 "../Core/Src/system_stm32f4xx.c"
...
void SystemInit(void)
{
  ...
  ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->VTOR = 0x08000000UL | 0x08000000;  
  ...
  switch (tmp)
  {
    ...
    case 0x08:   
      ...
      if (pllsource != 0)
      {
        ...
        pllvco = (((uint32_t)25000000U) / pllm) * ((((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->PLLCFGR & (0x1FFUL << (6U))) >> 6);
      }
      else
      {
...
#line 716 "../Core/Src/system_stm32f4xx.c"
