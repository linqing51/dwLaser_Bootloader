...
void HAL_I2C_MspInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  if(i2cHandle->Instance==((I2C_TypeDef *) (0x40000000UL + 0x5400UL)))
  {
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  if(i2cHandle->Instance==((I2C_TypeDef *) (0x40000000UL + 0x5400UL)))
  {
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0400UL)), ((uint16_t)0x0100));
