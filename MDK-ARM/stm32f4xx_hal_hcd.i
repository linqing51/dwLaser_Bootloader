...
#line 58 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
...
#line 147 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
...
#line 284 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
...
#line 994 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_hcd.c"
...
static void HCD_HC_IN_IRQHandler(HCD_HandleTypeDef *hhcd, uint8_t chnum)
{
  ...
  else if ((((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCINT & (0x1UL << (0U))) == (0x1UL << (0U)))
  {
    ...
    {
      hhcd->hc[ch_num].xfer_count = hhcd->hc[ch_num].xfer_len -                                     (((USB_OTG_HostChannelTypeDef *)(USBx_BASE + 0x500UL + ((ch_num) * 0x20UL)))->HCTSIZ & (0x7FFFFUL << (0U)));
