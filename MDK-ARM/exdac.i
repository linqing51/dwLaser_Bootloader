...
#line 2 "..\\Bootloader\\exdac.c"
 
static void setSYNC(uint8_t dat){
	if(dat){
		HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x2000), GPIO_PIN_SET);
	}
	else{
		HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x2000), GPIO_PIN_RESET);
	}
}
static void setCLK(uint8_t dat){
	if(dat){
		HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x8000), GPIO_PIN_SET);
	}
	else{
		HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x8000), GPIO_PIN_RESET);
	}
}
static void setDIN(uint8_t dat){
	if(dat){
		HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x4000), GPIO_PIN_SET);
	}
	else{
		HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x0800UL)), ((uint16_t)0x4000), GPIO_PIN_RESET);
	}
}
static void spiWrite(uint32_t dat){
	uint8_t tmp, i;
	setSYNC(1U);
