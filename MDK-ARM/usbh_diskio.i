...
#line 24 "../FATFS/Target/usbh_diskio.c"
...
#line 25 "../FATFS/Target/usbh_diskio.c"
...
DRESULT USBH_read(BYTE lun, BYTE *buff, DWORD sector, UINT count)
{
  ...
  else
  {
    ...
    case 0x3A:
    case 0x28:
      do { printf("ERROR: ") ; printf("USB Disk is not ready!"); printf("\n"); } while (0);
      res = RES_NOTRDY;
      break;
...
DRESULT USBH_write(BYTE lun, const BYTE *buff, DWORD sector, UINT count)
{
  ...
  else
  {
    ...
    {
    case 0x27:
      do { printf("ERROR: ") ; printf("USB Disk is Write protected!"); printf("\n"); } while (0);
      res = RES_WRPRT;
      break;
