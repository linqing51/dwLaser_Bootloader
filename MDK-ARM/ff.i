...
#line 651 "../Middlewares/Third_Party/FatFs/src/ff.c"
...
#line 684 "../Middlewares/Third_Party/FatFs/src/ff.c"
...
#line 762 "../Middlewares/Third_Party/FatFs/src/ff.c"
...
)
{
	...
	if (clst < 2 || clst >= fs->n_fatent) {	 
		...
		case 3 :
			...
			break;
#line 1064 "../Middlewares/Third_Party/FatFs/src/ff.c"
		default:
			val = 1;	 
		}
	}
...
#line 1263 "../Middlewares/Third_Party/FatFs/src/ff.c"
...
)
{
	...
	DWORD nxt;
	FATFS *fs = obj->fs;
#line 1286 "../Middlewares/Third_Party/FatFs/src/ff.c"
...
#line 1327 "../Middlewares/Third_Party/FatFs/src/ff.c"
		clst = nxt;					 
	} while (clst < fs->n_fatent);	 

#line 1341 "../Middlewares/Third_Party/FatFs/src/ff.c"
	return FR_OK;
}
...
#line 1399 "../Middlewares/Third_Party/FatFs/src/ff.c"
	{	 
		ncl = scl;	 
		for (;;) {
			ncl++;							 
...
#line 1780 "../Middlewares/Third_Party/FatFs/src/ff.c"



#line 1839 "../Middlewares/Third_Party/FatFs/src/ff.c"



#line 1862 "../Middlewares/Third_Party/FatFs/src/ff.c"



#line 2122 "../Middlewares/Third_Party/FatFs/src/ff.c"
...
#line 2166 "../Middlewares/Third_Party/FatFs/src/ff.c"
		{	 
			dp->obj.attr = a = dp->dir[11] & 0x3F;	 
#line 2188 "../Middlewares/Third_Party/FatFs/src/ff.c"
...
)
{
	...
	res = dir_sdi(dp, 0);			 
	if (res != FR_OK) return res;
#line 2243 "../Middlewares/Third_Party/FatFs/src/ff.c"
...
#line 2274 "../Middlewares/Third_Party/FatFs/src/ff.c"
...
)
{
	FRESULT res;
	FATFS *fs = dp->obj.fs;
#line 2366 "../Middlewares/Third_Party/FatFs/src/ff.c"
	res = dir_alloc(dp, 1);		 
...
#line 2435 "../Middlewares/Third_Party/FatFs/src/ff.c"
...
#line 2519 "../Middlewares/Third_Party/FatFs/src/ff.c"
	i = j = 0;
	while (i < 11) {		 
		c = (TCHAR)dp->dir[i++];
		if (c == ' ') continue;				 
...
#line 2610 "../Middlewares/Third_Party/FatFs/src/ff.c"
...
{
#line 2742 "../Middlewares/Third_Party/FatFs/src/ff.c"
	BYTE c, d, *sfn;
	UINT ni, si, i;
	const char *p;
	...
	mem_set(sfn, ' ', 11);
	si = i = 0; ni = 8;
#line 2763 "../Middlewares/Third_Party/FatFs/src/ff.c"
	for (;;) {
		c = (BYTE)p[si++];
		if (c <= ' ') break; 			 
		if (c == '/' || c == '\\') {	 
...
#line 2887 "../Middlewares/Third_Party/FatFs/src/ff.c"
			{
...
#line 3115 "../Middlewares/Third_Party/FatFs/src/ff.c"
	{
...
#line 3236 "../Middlewares/Third_Party/FatFs/src/ff.c"
	...
	if (res == FR_OK) {
		...
		if (mode & (0x08 | 0x10 | 0x04)) {
			...
			if (res == FR_OK && (mode & 0x08)) {	 
				dw = ((DWORD)(2015 - 1980) << 25 | (DWORD)6 << 21 | (DWORD)4 << 16);
#line 3390 "../Middlewares/Third_Party/FatFs/src/ff.c"
				{
...
#line 3443 "../Middlewares/Third_Party/FatFs/src/ff.c"
		...
		if (res == FR_OK) {
#line 3455 "../Middlewares/Third_Party/FatFs/src/ff.c"
			{
...
)
{
	...
	if (res == FR_OK) {
		if (fp->flag & 0x40) {	 
			...
			tm = ((DWORD)(2015 - 1980) << 25 | (DWORD)6 << 21 | (DWORD)4 << 16);				 
#line 3784 "../Middlewares/Third_Party/FatFs/src/ff.c"
			{
...
)
{
	...
	if (res == FR_OK) {
		...
		if (res == FR_OK) {						 
			if (!(dp->fn[11] & 0x80)) {	 
				if (obj->attr & 0x10) {		 
#line 4195 "../Middlewares/Third_Party/FatFs/src/ff.c"
					{
...
#line 4345 "../Middlewares/Third_Party/FatFs/src/ff.c"



#line 4817 "../Middlewares/Third_Party/FatFs/src/ff.c"



#line 4911 "../Middlewares/Third_Party/FatFs/src/ff.c"



#line 5132 "../Middlewares/Third_Party/FatFs/src/ff.c"



#line 5222 "../Middlewares/Third_Party/FatFs/src/ff.c"



#line 5293 "../Middlewares/Third_Party/FatFs/src/ff.c"
