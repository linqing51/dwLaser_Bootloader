...
uint32_t FLASH_If_EraseApplication(void){	
	...
	FirstSector = FLASH_If_GetSectorNumber(((uint32_t)0x08010000));
	 
	NbOfSectors = FLASH_If_GetSectorNumber((((uint32_t)0x0817FFFF) - 4)) - FirstSector + 1;
	FLASH_EraseInitStruct.TypeErase = 0x00000000U;
	FLASH_EraseInitStruct.Sector = FirstSector;
	FLASH_EraseInitStruct.NbSectors = NbOfSectors;
	FLASH_EraseInitStruct.VoltageRange = 0x00000002U;
...
uint32_t FLASH_If_EraseBootloader(void){
	...
	FirstSector = FLASH_If_GetSectorNumber(((uint32_t)0x08000000));
	 
	NbOfSectors = FLASH_If_GetSectorNumber((((uint32_t)0x0800FFFF) - 4)) - FirstSector + 1;
	FLASH_EraseInitStruct.TypeErase = 0x00000000U;
	FLASH_EraseInitStruct.Sector = FirstSector;
	FLASH_EraseInitStruct.NbSectors = NbOfSectors;
	FLASH_EraseInitStruct.VoltageRange = 0x00000002U;
...
uint32_t FLASH_If_Write(uint32_t Address, uint32_t Data)
{
  ...
  if (Address <= (uint32_t)(((uint32_t)0x0817FFFF) - 4))
  {
    if (HAL_FLASH_Program(0x00000002U, Address, Data) != HAL_OK)
      return (1);
  }
  else
  {
...
static uint32_t FLASH_If_GetSectorNumber(uint32_t Address)
{
  ...
  else if (Address < ((uint32_t)0x08100000) && Address >= ((uint32_t)0x080E0000))
  {
    sector = 11U;
  }
  else if (Address < ((uint32_t)0x08120000) && Address >= ((uint32_t)0x08100000))
  {
    sector = 12U;
  }
  else if (Address < ((uint32_t)0x08140000) && Address >= ((uint32_t)0x08120000))
  {
    sector = 13U;
  }
  else if (Address < ((uint32_t)0x08160000) && Address >= ((uint32_t)0x08140000))
  {
    sector = 14U;
  }
  else
