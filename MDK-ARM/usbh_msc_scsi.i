...
#line 29 "../Middlewares/ST/STM32_USB_Host_Library/Class/MSC/Src/usbh_msc_scsi.c"
#line 30 "../Middlewares/ST/STM32_USB_Host_Library/Class/MSC/Src/usbh_msc_scsi.c"
#line 31 "../Middlewares/ST/STM32_USB_Host_Library/Class/MSC/Src/usbh_msc_scsi.c"
                                               ...
                                               uint8_t lun)
{
  ...
  switch (MSC_Handle->hbot.cmd_state)
  {
    case BOT_CMD_SEND:
      ...
      MSC_Handle->hbot.cbw.field.Flags = 0x00U;
      MSC_Handle->hbot.cbw.field.CBLength = 10U;

      memset(MSC_Handle->hbot.cbw.field.CB, 0, 16U);
      MSC_Handle->hbot.cbw.field.CB[0]  = 0x00U;
                                              ...
                                              SCSI_CapacityTypeDef *capacity)
{
  ...
  switch (MSC_Handle->hbot.cmd_state)
  {
    case BOT_CMD_SEND:
      ...
      MSC_Handle->hbot.cbw.field.DataTransferLength = 8U;
      MSC_Handle->hbot.cbw.field.Flags = 0x80U;
      MSC_Handle->hbot.cbw.field.CBLength = 10U;

      memset(MSC_Handle->hbot.cbw.field.CB, 0, 16U);
      MSC_Handle->hbot.cbw.field.CB[0]  = 0x25U;
    ...
    case BOT_CMD_WAIT:
      ...
      if (error == USBH_OK)
      {
        ...
        capacity->block_nbr = MSC_Handle->hbot.pbuf[3] | ((uint32_t)MSC_Handle->hbot.pbuf[2] << 8U) |                               ((uint32_t)MSC_Handle->hbot.pbuf[1] << 16U) | ((uint32_t)MSC_Handle->hbot.pbuf[0] << 24U);
                                         ...
                                         SCSI_StdInquiryDataTypeDef *inquiry)
{
  ...
  switch (MSC_Handle->hbot.cmd_state)
  {
    case BOT_CMD_SEND:
      ...
      MSC_Handle->hbot.cbw.field.DataTransferLength = 36U;
      MSC_Handle->hbot.cbw.field.Flags = 0x80U;
      MSC_Handle->hbot.cbw.field.CBLength = 10U;

      memset(MSC_Handle->hbot.cbw.field.CB, 0, 10U);
      MSC_Handle->hbot.cbw.field.CB[0]  = 0x12U;
    ...
    case BOT_CMD_WAIT:
      ...
      if (error == USBH_OK)
      {
        ...
        memcpy(inquiry->vendor_id, &MSC_Handle->hbot.pbuf[8], 8U);
        memcpy(inquiry->product_id, &MSC_Handle->hbot.pbuf[16], 16U);
        memcpy(inquiry->revision_id, &MSC_Handle->hbot.pbuf[32], 4U);
      }
      break;
                                              ...
                                              SCSI_SenseTypeDef *sense_data)
{
  ...
  switch (MSC_Handle->hbot.cmd_state)
  {
    case BOT_CMD_SEND:
      ...
      MSC_Handle->hbot.cbw.field.DataTransferLength = 14U;
      MSC_Handle->hbot.cbw.field.Flags = 0x80U;
      MSC_Handle->hbot.cbw.field.CBLength = 10U;

      memset(MSC_Handle->hbot.cbw.field.CB, 0, 16U);
      MSC_Handle->hbot.cbw.field.CB[0]  = 0x03U;
      MSC_Handle->hbot.cbw.field.CB[1]  = (lun << 5);
      MSC_Handle->hbot.cbw.field.CB[2]  = 0U;
      MSC_Handle->hbot.cbw.field.CB[3]  = 0U;
      MSC_Handle->hbot.cbw.field.CB[4]  = 14U;
      MSC_Handle->hbot.cbw.field.CB[5]  = 0U;
                                       ...
                                       uint32_t length)
{
  ...
  switch (MSC_Handle->hbot.cmd_state)
  {
    case BOT_CMD_SEND:
      ...
      memset(MSC_Handle->hbot.cbw.field.CB, 0, 16U);
      MSC_Handle->hbot.cbw.field.CB[0]  = 0x2AU;
                                      ...
                                      uint32_t length)
{
  ...
  switch (MSC_Handle->hbot.cmd_state)
  {
    case BOT_CMD_SEND:
      ...
      memset(MSC_Handle->hbot.cbw.field.CB, 0, 16U);
      MSC_Handle->hbot.cbw.field.CB[0]  = 0x28U;
