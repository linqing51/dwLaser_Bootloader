...
void MX_DAC_Init(void)
{
  ...
  sConfig.DAC_Trigger = 0x00000000U;
  sConfig.DAC_OutputBuffer = 0x00000000U;
  if (HAL_DAC_ConfigChannel(&hdac, &sConfig, 0x00000010U) != HAL_OK)
  {
    Error_Handler();
  }
...
void HAL_DAC_MspInit(DAC_HandleTypeDef* dacHandle)
{
  ...
  if(dacHandle->Instance==((DAC_TypeDef *) (0x40000000UL + 0x7400UL)))
  {
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* dacHandle)
{
  ...
  if(dacHandle->Instance==((DAC_TypeDef *) (0x40000000UL + 0x7400UL)))
  {
    ...
    (((RCC_TypeDef *) ((0x40000000UL + 0x00020000UL) + 0x3800UL))->APB1ENR &= ~((0x1UL << (29U))));
