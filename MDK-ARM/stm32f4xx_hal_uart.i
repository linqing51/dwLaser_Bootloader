...
#line 357 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
...
#line 423 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
...
#line 499 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
...
#line 581 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
...
#line 649 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
...
#line 930 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
...
#line 2533 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
...
static void UART_SetConfig(UART_HandleTypeDef *huart)
{
  ...
  if (huart->Init.OverSampling == ((uint32_t)(0x1UL << (15U))))
  {
    ...
    if ((huart->Instance == ((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1000UL))) || (huart->Instance == ((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1400UL))) || (huart->Instance == ((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1800UL))) || (huart->Instance == ((USART_TypeDef *) ((0x40000000UL + 0x00010000UL) + 0x1C00UL))))
    {
...
#line 3116 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
    else
    {
...
#line 3144 "../Drivers/STM32F4xx_HAL_Driver/Src/stm32f4xx_hal_uart.c"
    else
    {
      pclk = HAL_RCC_GetPCLK1Freq();
      huart->Instance->BRR = (((((uint32_t)((((uint64_t)(((pclk))))*25U)/(4U*((uint64_t)(((huart->Init . BaudRate)))))))/100U) << 4U) + (((((((uint32_t)((((uint64_t)(((pclk))))*25U)/(4U*((uint64_t)(((huart->Init . BaudRate))))))) - ((((uint32_t)((((uint64_t)((((pclk)))))*25U)/(4U*((uint64_t)((((huart->Init . BaudRate))))))))/100U) * 100U)) * 16U) + 50U) / 100U) & 0xF0U) + (((((((uint32_t)((((uint64_t)(((pclk))))*25U)/(4U*((uint64_t)(((huart->Init . BaudRate))))))) - ((((uint32_t)((((uint64_t)((((pclk)))))*25U)/(4U*((uint64_t)((((huart->Init . BaudRate))))))))/100U) * 100U)) * 16U) + 50U) / 100U) & 0x0FU));
