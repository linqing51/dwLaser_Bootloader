...
#line 41 "../Middlewares/ST/STM32_USB_Host_Library/Class/MSC/Src/usbh_msc.c"
#line 42 "../Middlewares/ST/STM32_USB_Host_Library/Class/MSC/Src/usbh_msc.c"
#line 43 "../Middlewares/ST/STM32_USB_Host_Library/Class/MSC/Src/usbh_msc.c"
...
static USBH_StatusTypeDef USBH_MSC_InterfaceInit(USBH_HandleTypeDef *phost)
{
  ...
  interface = USBH_FindInterface(phost, phost->pActiveClass->ClassCode, 0x06U, 0x50U);

  if ((interface == 0xFFU) || (interface >= 2U))  
  {
    do { printf("DEBUG : ") ; printf("Cannot Find the interface for %s class.", phost->pActiveClass->Name); printf("\n"); } while (0);
    return USBH_FAIL;
  }
  ...
  if (MSC_Handle == 0)
  {
    do { printf("DEBUG : ") ; printf("Cannot allocate memory for MSC Handle"); printf("\n"); } while (0);
    return USBH_FAIL;
  }
...
static USBH_StatusTypeDef USBH_MSC_ClassRequest(USBH_HandleTypeDef *phost)
{
  ...
  switch (MSC_Handle->req_state)
  {
    ...
    case MSC_REQ_GET_MAX_LUN:
      ...
      if (status == USBH_OK)
      {
        MSC_Handle->max_lun = (MSC_Handle->max_lun > 2U) ? 2U : (MSC_Handle->max_lun + 1U);
        do { printf("Number of supported LUN: %d", MSC_Handle ->max_lun); printf("\n"); } while (0);
  ...
  switch (MSC_Handle->state)
  {
    case MSC_INIT:
      ...
      if (MSC_Handle->current_lun < MSC_Handle->max_lun)
      {
        ...
        {
          case MSC_INIT:
            do { printf("LUN #%d: ", MSC_Handle ->current_lun); printf("\n"); } while (0);
          ...
          case MSC_READ_INQUIRY:
            ...
            {
              do { printf("Inquiry Vendor  : %s", MSC_Handle ->unit[MSC_Handle ->current_lun]. inquiry . vendor_id); printf("\n"); } while (0);
              do { printf("Inquiry Product : %s", MSC_Handle ->unit[MSC_Handle ->current_lun]. inquiry . product_id); printf("\n"); } while (0);
              do { printf("Inquiry Version : %s", MSC_Handle ->unit[MSC_Handle ->current_lun]. inquiry . revision_id); printf("\n"); } while (0);
          ...
          case MSC_TEST_UNIT_READY:
            ...
            if (ready_status == USBH_OK)
            {
              if (MSC_Handle->unit[MSC_Handle->current_lun].prev_ready_state != USBH_OK)
              {
                ...
                do { printf("MSC Device ready"); printf("\n"); } while (0);
              }
              else
              {
            ...
            if (ready_status == USBH_FAIL)
            {
              ...
              {
                MSC_Handle->unit[MSC_Handle->current_lun].state_changed = 1U;
                do { printf("MSC Device NOT ready"); printf("\n"); } while (0);
              }
              else
              {
                MSC_Handle->unit[MSC_Handle->current_lun].state_changed = 0U;
          ...
          case MSC_READ_CAPACITY10:
            ...
            if (scsi_status == USBH_OK)
            {
              ...
              {
                do { printf("MSC Device capacity : %lu Bytes", (int32_t)(MSC_Handle ->unit[MSC_Handle ->current_lun]. capacity . block_nbr * MSC_Handle ->unit[MSC_Handle ->current_lun]. capacity . block_size)); printf("\n"); } while (0);

                do { printf("Block number : %lu", (int32_t)(MSC_Handle ->unit[MSC_Handle ->current_lun]. capacity . block_nbr)); printf("\n"); } while (0);
                do { printf("Block Size   : %lu", (int32_t)(MSC_Handle ->unit[MSC_Handle ->current_lun]. capacity . block_size)); printf("\n"); } while (0);
              }
              MSC_Handle->unit[MSC_Handle->current_lun].state = MSC_IDLE;
              MSC_Handle->unit[MSC_Handle->current_lun].error = MSC_OK;
          ...
          case MSC_REQUEST_SENSE:
            ...
            if (scsi_status == USBH_OK)
            {
              if ((MSC_Handle->unit[MSC_Handle->current_lun].sense.key == 0x06U) ||
                  (MSC_Handle->unit[MSC_Handle->current_lun].sense.key == 0x02U))
              {
              ...
              do { printf("Sense Key  : %x", MSC_Handle ->unit[MSC_Handle ->current_lun]. sense . key); printf("\n"); } while (0);
              do { printf("Additional Sense Code : %x", MSC_Handle ->unit[MSC_Handle ->current_lun]. sense . asc); printf("\n"); } while (0);
              do { printf("Additional Sense Code Qualifier: %x", MSC_Handle ->unit[MSC_Handle ->current_lun]. sense . ascq); printf("\n"); } while (0);
              MSC_Handle->unit[MSC_Handle->current_lun].state = MSC_IDLE;
              MSC_Handle->current_lun++;
            }
            if (scsi_status == USBH_FAIL)
...
#line 496 "../Middlewares/ST/STM32_USB_Host_Library/Class/MSC/Src/usbh_msc.c"
      }
      else
      {
...
#line 510 "../Middlewares/ST/STM32_USB_Host_Library/Class/MSC/Src/usbh_msc.c"
...
static USBH_StatusTypeDef USBH_MSC_RdWrProcess(USBH_HandleTypeDef *phost, uint8_t lun)
{
  ...
  switch (MSC_Handle->unit[lun].state)
  {
    ...
    case MSC_READ:
      scsi_status = USBH_MSC_SCSI_Read(phost, lun, 0U, 0, 0U);
...
#line 584 "../Middlewares/ST/STM32_USB_Host_Library/Class/MSC/Src/usbh_msc.c"
      break;

    case MSC_WRITE:
      scsi_status = USBH_MSC_SCSI_Write(phost, lun, 0U, 0, 0U);
...
#line 615 "../Middlewares/ST/STM32_USB_Host_Library/Class/MSC/Src/usbh_msc.c"
      break;
    ...
    case MSC_REQUEST_SENSE:
      ...
      if (scsi_status == USBH_OK)
      {
        do { printf("Sense Key  : %x", MSC_Handle ->unit[lun]. sense . key); printf("\n"); } while (0);
        do { printf("Additional Sense Code : %x", MSC_Handle ->unit[lun]. sense . asc); printf("\n"); } while (0);
        do { printf("Additional Sense Code Qualifier: %x", MSC_Handle ->unit[lun]. sense . ascq); printf("\n"); } while (0);
        MSC_Handle->unit[lun].state = MSC_IDLE;
...
#line 651 "../Middlewares/ST/STM32_USB_Host_Library/Class/MSC/Src/usbh_msc.c"
      break;
